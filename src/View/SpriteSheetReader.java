...
public class SpriteSheetReader {
    ...
    private final String spriteSheetPos = "src/View/SpriteSheets/Base.png";
    ...
    public SpriteSheetReader(int _tileSize) {
        ...
        try {
            ...
            System.out.println("Sprite sheet invalid, if not intentional please change the value in the sprite sheet reader");
//            e.printStackTrace();
        }
    }
    ...
    public int[][] retrievePixels(RenderInfo r){
        ...
        if (!spritesInitialized) return toReturn;

        Point pos = r.getSprite().getPosition();
        Point tileOffset = new Point(pos.y * tileSize, pos.x * tileSize);
